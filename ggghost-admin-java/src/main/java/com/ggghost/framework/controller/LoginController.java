...
public class LoginController {
    ...
    public ResponseInfo login(@RequestBody @Validated LoginUser loginUser) {
    ...
    public ResponseInfo register(@RequestBody @Validated({ValidGroup.register.class}) LoginUser user) {
